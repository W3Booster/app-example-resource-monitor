...
for (const [text, href] of [['Setup guide', 'https://w3booster.com/developer/first-app/'], ['View source', 'https://github.com/W3Booster/app-example-resource-monitor'], ['SDK reference', 'https://w3booster.com/developer/api/']]) {
